          ...
          ListHeaderComponent={
            <>
              ...
              >
                ...
                <AppText variant="semibold" style={styles.manageDiseasesText}>
                  App Pages — edit About, Terms & Contact
                </AppText>
                <Feather name="chevron-right" size={16} color={colors.muted} />
              </Pressable>
              <Pressable
