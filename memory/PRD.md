...
- Home banners (auto-scroll carousel, admin gallery uploads) — displayed in a large 16:9 ratio; the old "Rooted in Nature" hero image was removed (June 2026) so banners are the first visual under the logo.
